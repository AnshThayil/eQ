...
/**
 * SaveIcon - Unsaved state
 * White fill with pink border
 */
export function SaveIcon({ size = 24 }: IconProps) {
  const fillColor = Theme.colors.neutral.white;
  const strokeColor = Theme.colors.primary[500];
