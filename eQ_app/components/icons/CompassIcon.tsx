...
export function CompassIcon({ size = 40, color = '#332F74' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 40 40" fill="none">
      <Circle cx="20" cy="20" r="15.25" stroke={color} strokeWidth="1.5" />
      <Path
        ...
        strokeWidth="1.5"
      />
      <Circle cx="20" cy="20" r="2.25" stroke={color} strokeWidth="1.5" />
    </Svg>
  );
}
