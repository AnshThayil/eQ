...
/**
 * SaveIconSelected - Saved state
 * Pink fill with white border
 */
export function SaveIconSelected({ size = 24 }: IconProps) {
  const fillColor = Theme.colors.primary[500];
  const strokeColor = Theme.colors.neutral.white;
