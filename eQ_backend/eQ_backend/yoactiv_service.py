...
class YoActivClient:
    ...
    def __init__(self, api_key=None, branch_id=None, base_url=None, timeout=20):
        ...
        self.branch_id = branch_id or os.environ.get("YOACTIV_BRANCH_ID")
        ...
        if not self.branch_id:
            raise ValueError("YoActiv branch id is required. Pass branch_id or set YOACTIV_BRANCH_ID.")
    ...
    def put(self, endpoint: str, *, json=None, params=None, headers=None, timeout=None):
        return self.request("PUT", endpoint, params=params, json=json, headers=headers, timeout=timeout)
