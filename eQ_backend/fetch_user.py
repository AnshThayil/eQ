...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Fetch a YoActiv user by mobile number."
    )
    parser.add_argument("mobile_no", help="Mobile number to fetch, e.g. 8881888888")
    ...
    url = "https://api.yoactiv.com/Users/Fetch"
    payload = {"Mobile_No": args.mobile_no}
    headers = {
        "API_Key": api_key,
        "Branch_Id": branch_id,
    ...
    print("=" * 60)
    print("Fetch User By Mobile Number")
    print("=" * 60)
    print(f"Mobile No: {args.mobile_no}")
